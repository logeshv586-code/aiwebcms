...
test('storefront quality source contracts stay wired',()=>{
  ...
  assert.match(faq,/FAQPage/); assert.match(faq,/breadcrumbSchema/); assert.match(home,/storeSchema/); assert.match(home,/content\.imageAlt/); assert.match(homepage,/Image (alt text|description for SEO\/accessibility)/);
